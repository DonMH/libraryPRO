...
if(isset($_POST['submit'])){
    ...
    $isSuccess = $crud->insertUsers($name, $email, $dob, $mob, $yob, $gender, $password);
    if($isSuccess){       
        echo '<div class="alert alert-success" style="text-align: center;">CONGRATULATIONS!.You have signed up. </div>';
        }
        else{
