...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $result = $admin->getAdmin($email,$new_password);
    if(!$result){
...
<p class="text-center m-b-30 slog"><strong class="sign_up_title">تسجيل الدخول</strong><br><span style="font-size: large;">مسؤول</span></p>
<div class="row">
