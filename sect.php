...
window.onclick = function(event) {
  ...
  <?php $cnt = 0;?>
	...
	<div class="sect-box">
	<h1 style="line-height: 1.3; margin-bottom: 3rem;" class="f-s-25 m-b-30">أقسام الكتب</h1>
  ...
  <i class="fa fa-book"></i> <?php echo $r['category_name']?></a>
    </h4>  
